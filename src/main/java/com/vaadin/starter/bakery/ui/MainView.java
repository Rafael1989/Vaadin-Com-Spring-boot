...
import com.vaadin.starter.bakery.ui.views.admin.audit.AuditView;
...
import static com.vaadin.starter.bakery.ui.utils.BakeryConst.ICON_AUDIT;
import static com.vaadin.starter.bakery.ui.utils.BakeryConst.TITLE_AUDIT;
...
public class MainView extends PolymerTemplate<TemplateModel>
	...
	public MainView() {
		...
		if (SecurityUtils.isAccessGranted(AuditView.class)) {
			pages.add(new PageInfo(PAGE_AUDIT, ICON_AUDIT, TITLE_AUDIT));
		}
